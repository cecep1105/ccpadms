...
urlpatterns = [
    ...
    path('mobile-pool-loc/draw/', views.mobile_pool_loc_draw, name='mobile_pool_loc_draw'),
    path('mobile-pool-loc/draw/<str:pool_id>/', views.mobile_pool_loc_draw, name='mobile_pool_loc_draw_edit'),
    path('mobile-pool-loc/draw/<str:pool_id>/save/', views.mobile_pool_loc_draw_save, name='mobile_pool_loc_draw_save'),
